                ...
                <div class="panel-body">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <center>
                                    <img src='{{ url($bookPost->image_uri) }}' class="img-thumbnail"
                            ...
                            @if (auth()->check() && auth()->user()->id == $bookPost->user_id)
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title text-center" id="myModalLabel">Delete Confirmation
                                                </h4>
                                            </div>
                                            <form action="{id}/delete" method="post">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-success" data-dismiss="modal">No,
                                                        Cancel</button>
                                                    <a href="{{ $bookPost->id }}/delete" class="btn btn-danger"> Yes
                                                        ,Delete</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{$bookPost->bookPostOwner->name}}
                                    @if ($bookPost->bookPostOwner->isCreatedByAdmin)
                                    <span style="color: lightcoral"><i class="fa fa-check-circle"
